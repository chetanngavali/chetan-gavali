...
import { ChevronDown, Shield, Camera, Palette, Code, Laptop } from "lucide-react";
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-3/2 w-10 h-10 bg-cyber-pink/20 rounded-xl rotate-45 animate-float opacity-90 hover-tilt" style={{ animationDelay: "3s", transform: "perspective(1000px) rotateX(-5deg) rotateY(20deg)" }}>
          <Laptop className="w-5 h-5 text-cyber-pink absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -rotate-45" />
        </div>
      </div>
